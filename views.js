...
function renderStats(){
  ...
  <div class="section">
    ...
    <div class="card">
      <div class="row tap" data-act="bucketList" data-v="income"><div class="row-main"><div class="row-title">이번 달 수입</div></div><div class="row-val c-income num">${won(sm.income)}</div><div class="chev">›</div></div>
